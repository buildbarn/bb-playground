...
func (c *baseComputer[TReference]) ComputeRegisteredToolchainsForTypeValue(ctx context.Context, key *model_analysis_pb.RegisteredToolchainsForType_Key, e RegisteredToolchainsForTypeEnvironment[TReference]) (PatchedRegisteredToolchainsForTypeValue, error) {
