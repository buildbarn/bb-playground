...
func (c *baseComputer) ComputeStableInputRootPathValue(ctx context.Context, key *model_analysis_pb.StableInputRootPath_Key, e StableInputRootPathEnvironment) (PatchedStableInputRootPathValue, error) {
	...
	if !gotCommandEncoder || !gotDirectoryCreationParameters || !directoryCreationParametersValue.IsSet() || !fileCreationParametersValue.IsSet() || !gotFileReader || !repoPlatform.IsSet() {
	...
	outputs, err := c.getOutputsFromActionResult(ctx, actionResult, directoryCreationParameters.DirectoryAccessParameters)
	if err != nil {
...
func (c *baseComputer) ComputeStableInputRootPathObjectValue(ctx context.Context, key *model_analysis_pb.StableInputRootPathObject_Key, e StableInputRootPathObjectEnvironment) (*model_starlark.Path, error) {
