...
func NewUniformProllyBuilder[TNode proto.Message, TMetadata any](minimumSizeBytes, maximumSizeBytes int, nodeMerger NodeMerger[TNode, TMetadata]) Builder[TNode, TMetadata] {
...
func NewSplitProllyBuilder[TNode proto.Message, TMetadata any](minimumSizeBytes, maximumSizeBytes int, nodeMerger NodeMerger[TNode, TMetadata]) Builder[TNode, TMetadata] {
