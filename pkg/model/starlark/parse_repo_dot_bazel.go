...
func getDefaultInheritableAttrs(thread *starlark.Thread, b *starlark.Builtin, args starlark.Tuple, kwargs []starlark.Tuple, previousInheritableAttrs model_core.Message[*model_starlark_pb.InheritableAttrs], inlinedTreeOptions *inlinedtree.Options) (model_core.PatchedMessage[*model_starlark_pb.InheritableAttrs, model_core.CreatedObjectTree], error) {
	if len(args) > 0 {
