...
import (
	...
	model_command "github.com/buildbarn/bb-playground/pkg/model/command"
	model_filesystem_virtual "github.com/buildbarn/bb-playground/pkg/model/filesystem/virtual"
	"github.com/buildbarn/bb-playground/pkg/proto/configuration/playground_worker"
...
func main() {
	program.RunMain(func(ctx context.Context, siblingsGroup, dependenciesGroup program.Group) error {
		if len(os.Args) != 2 {
			return status.Error(codes.InvalidArgument, "Usage: playground_worker playground_worker.jsonnet")
		}
		var configuration playground_worker.ApplicationConfiguration
